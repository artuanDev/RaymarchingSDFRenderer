...
| Dirty scene version | Retained, split into diagnostic dirty flags, and paired with edit/play transform checks. |
...
| Profiler markers | Retained for CPU compilation/upload and GPU raymarch pass. |
